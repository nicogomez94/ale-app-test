...
export const debugData = {
  ...
  policy: {
    clienteNombre: 'Laura Martinez',
    clienteDni: '31456789',
    clienteTelefono: '1187654321',
    clienteEmail: 'laura.martinez@email.com',
    clienteDireccion: 'Av. Santa Fe',
    clienteAltura: '2450',
    clienteCp: '1425',
    clienteProvincia: 'CABA',
    clienteLocalidad: 'Palermo',
    aseguradora: 'Sancor Seguros',
    rubro: 'Automoviles',
