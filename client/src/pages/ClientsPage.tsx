...
const status = (policy: any) => policy.pagada ? { label: 'PAGADA', bg: '#edf8ed', color: '#25843a' } : policy.estado === 'VENCIDA' ? { label: 'VENCIDA', bg: '#fff0f0', color: '#dc2d2d' } : { label: policy.estado === 'VENCE_PRONTO' ? 'VENCE PRONTO' : 'VIGENTE', bg: '#fff', color: '#37a654' };
