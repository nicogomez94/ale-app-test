    ...
    children: [
      ...
      new Table({
        ...
        rows: [
          ...
          new TableRow({ children: [ dataCell('Pagos en línea', false, true), dataCell('MercadoPago — transferencia, tarjeta de crédito (cobro automático mensual) o tarjeta de débito') ]}),
      ...
      bullet('Organización de pólizas por rubros (Automóvil, Moto, Celular / Electrónica, Hogar, ART, Flotas, etc.).'),
      ...
      bullet('Cada fila muestra: cliente, rubro (Auto, Moto, Hogar, etc.), aseguradora, fecha de vencimiento, días restantes, medio de pago, estado (Activa / Vence pronto / Vencida) y acciones.'),
      spacer(),
      ...
      bullet('Rubro (con autocompletado): Automóvil, Moto, Celular / Electrónica, Hogar, Vida, Retiro, ART, Integral de Comercio, TRO, Consorcio, Flotas y más. El productor también puede escribir un rubro personalizado.'),
      bullet('Número de póliza'),
      bullet('Fecha de inicio'),
      bullet('Fecha de vencimiento (por defecto: 1 año desde hoy)'),
      bullet('Medio de pago de la póliza: Transferencia, Tarjeta de crédito o Tarjeta de débito.'),
      spacer(),
      h3('Sección: Comisión'),
      ...
      bullet('Gráfico de torta: distribución de comisiones por rubro (Auto, Moto, Hogar, Vida, Otros).'),
      spacer(),
      ...
      body('Sección donde el productor puede ver su plan actual, los planes disponibles y pagar dentro de la misma plataforma. Los pagos se procesan a través de MercadoPago y se aceptan: transferencia bancaria, tarjeta de crédito y tarjeta de débito.'),
      spacer(),
      ...
      bullet('Métodos de pago aceptados via MercadoPago: transferencia bancaria, tarjeta de crédito o tarjeta de débito.'),
      bullet('Pago con tarjeta de crédito: se configura como cobro automático mensual. El sistema renueva la suscripción automáticamente hasta que el productor solicite la baja.'),
      ...
      spacer(),
      h3('Recordatorios de vencimiento de suscripción:'),
      bullet('A partir de los 5 días previos al vencimiento, el sistema muestra dentro de la plataforma un aviso con la opción de renovar/pagar directamente.'),
      bullet('Si el productor no renueva, recibe una notificación diaria indicando cuántos días le quedan ("Te quedan 4 días", "Te quedan 3 días", etc.).'),
      bullet('El día del vencimiento, el acceso queda restringido hasta que se realice el pago.'),
      italic('Este sistema aplica a todos los planes pagos. El plan de prueba (10 días) también avisa con anticipación antes de bloquearse.'),
      ...
      bullet('4. Elige el método de pago: transferencia, tarjeta de crédito o débito.'),
      bullet('5. Si paga con tarjeta de crédito, el cobro se renueva automáticamente cada mes hasta que solicite la baja.'),
      bullet('6. Al volver, su plan queda activo automáticamente.'),
      spacer(),

      h2('Flujo 5 — Recordatorios de vencimiento de suscripción'),
      bullet('1. Faltan 5 días para que venza el plan: el sistema muestra un aviso dentro de la plataforma con la opción de renovar.'),
      bullet('2. Si el productor no renueva, cada día recibe una notificación indicando cuántos días le quedan.'),
      bullet('3. Al vencer, el acceso queda bloqueado hasta completar el pago.'),
      bullet('4. El productor puede reactivar su plan desde la sección de Suscripción en cualquier momento.'),
