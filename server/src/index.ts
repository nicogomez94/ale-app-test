...
app.use("/api/policy-imports", authMiddleware, subscriptionGuard, policyImportsRouter);
app.use("/api/policy-documents", authMiddleware, subscriptionGuard, policyDocumentsRouter);
